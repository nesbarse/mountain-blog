    ...
    public ReplyBean getcount() throws Exception {
        if (this.checkpermission("getcount")) {
            ...
            try {
                ...
                ComentarioDao oComentarioDao = new ComentarioDao(oConnection, (UsuarioBean) oRequest.getSession().getAttribute("userBean"), null);
                data = JsonMessage.getJsonExpression(200, Long.toString(oComentarioDao.getCount(alFilter)));
            } catch (Exception ex) {
    ...
    public ReplyBean get() throws Exception {
        if (this.checkpermission("get")) {
            ...
            try {
                ...
                oComentarioBean = oComentarioDao.get(oComentarioBean, AppConfigurationHelper.getJsonMsgDepth());
                Gson gson = AppConfigurationHelper.getGson();
                data = JsonMessage.getJsonExpression(200, AppConfigurationHelper.getGson().toJson(oComentarioBean));
            } catch (Exception ex) {
                Log4j.errorLog(this.getClass().getName() + ":" + (ex.getStackTrace()[0]).getMethodName(), ex);
                throw new Exception();
            } finally {
    ...
    public ReplyBean getall() throws Exception {
        if (this.checkpermission("getall")) {
            ...
            try {
                ...
                oConnection = oDataConnectionSource.newConnection();
                ComentarioDao oComentarioDao = new ComentarioDao(oConnection, (UsuarioBean) oRequest.getSession().getAttribute("userBean"), null);
                ArrayList<ComentarioBean> arrBeans = oComentarioDao.getAll(alFilter, hmOrder, AppConfigurationHelper.getJsonMsgDepth());
    ...
    public ReplyBean getpage() throws Exception {
        if (this.checkpermission("getpage")) {
            ...
            try {
                ...
                oConnection = oDataConnectionSource.newConnection();
                ComentarioDao oComentarioDao = new ComentarioDao(oConnection, (UsuarioBean) oRequest.getSession().getAttribute("userBean"), null);
                List<ComentarioBean> arrBeans = oComentarioDao.getPage(intRegsPerPag, intPage, alFilter, hmOrder, AppConfigurationHelper.getJsonMsgDepth());
                data = JsonMessage.getJsonExpression(200, AppConfigurationHelper.getGson().toJson(arrBeans));
            } catch (Exception ex) {
                Log4j.errorLog(this.getClass().getName() + ":" + (ex.getStackTrace()[0]).getMethodName(), ex);
                throw new Exception();
    ...
    public ReplyBean remove() throws Exception {
        if (this.checkpermission("remove")) {
            ...
            try {
                ...
                ComentarioDao oComentarioDao = new ComentarioDao(oConnection, (UsuarioBean) oRequest.getSession().getAttribute("userBean"), null);
                data = JsonMessage.getJsonExpression(200, (String) oComentarioDao.remove(id).toString());
                oConnection.commit();
            } catch (Exception ex) {
                if (oConnection != null) {
